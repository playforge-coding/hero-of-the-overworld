...
each with a description and an optional **attack animation** — a lunge, a flying
**projectile**, or a screen-wrapping **charge** — plus a character knows some from the
start and unlocks others via a level-gated **learnset**), **equipment** (weapons and
armor with stat bonuses, crit /
